...
public class TicketApplication {
	...
	public CommandLineRunner demo(EventRepository erepository, CategoryRepository crepository,
		...
		return (args) -> {
			...
			crepository.save(new Category("Rock"));
			crepository.save(new Category("Metal"));
			crepository.save(new Category("Rap"));
			crepository.save(new Category("Kulttuuri"));
			crepository.save(new Category("Musical"));

			// add avenues
			vrepository.save(new Venue("Venue 1", "Very nice place in Kamppi", "kampinjokukatu 3"));
			vrepository.save(new Venue("Venue 2", "Very nice place in Kamppi", "kampinjokukatu 4"));
			vrepository.save(new Venue("Venue 3", "Very nice place in Kamppi", "kampinjokukatu 5"));
			vrepository.save(new Venue("Venue 4", "Very nice place in Kamppi", "kampinjokukatu 6"));
			vrepository.save(new Venue("Venue 5", "Very nice place in Kamppi", "kampinjokukatu 7"));
			...
			User user2 = new User("admin", "$2a$10$0MMwY.IQqpsVc1jC8u7IJ.2rT8b0Cd3b3sfIBGV2zfgnPGtT4r0.C", "ADMIN",
					"admin@mail.com");
			User user3 = new User("host", "$2a$10$xugaw2oi4QD6g1hF8.n9yupWduIeK68RfbDD4xd3QzDk5zCvp9nDS", "HOST",
					"host@mail.com");
			User user4 = new User("ghost", "$2a$10$xugaw2oi4QD6g1hF8.n9yupWduIeK68RfbDD4xd3QzDk5zCvp9nDS", "HOST",
					"host@mail.com");
			...
			log.info("Hello before event");
			Event event1 = new Event();
			erepository.save(event1);
			event1.setTitle("Testieventti");
			event1.setUser(user2);
			event1.setCategory(
					Arrays.asList(crepository.findByName("Football").get(0), crepository.findByName("Metal").get(0)));
			event1.setDescription("testi tapahtuma");
			event1.setTicketLimit(10);
			event1.setStartDate("2021-03-15");
			event1.setStartTime("13:00");
			event1.setPrice(20);
			event1.setVenue(vrepository.findByName("Venue 3").get(0));

			Event event2 = new Event();
			erepository.save(event2);
			event2.setTitle("Testieventti 2");
			event2.setUser(user3);
			event2.setCategory(
					Arrays.asList(crepository.findByName("Football").get(0), crepository.findByName("Metal").get(0)));
			event2.setDescription("testi tapahtuma 2");
			event2.setTicketLimit(10);
			event2.setStartDate("2021-04-15");
			event2.setStartTime("12:00");
			event2.setPrice(20);
			event2.setVenue(vrepository.findByName("Venue 2").get(0));

			Event event3 = new Event();
			erepository.save(event3);
			event3.setTitle("Testieventti 3");
			event3.setUser(user4);
			event3.setCategory(
					Arrays.asList(crepository.findByName("Football").get(0), crepository.findByName("Metal").get(0)));
			event3.setDescription("testi tapahtuma 2");
			event3.setTicketLimit(10);
			event3.setStartDate("2021-05-25");
			event3.setStartTime("18:00");
			event3.setPrice(20);
			...
			trepository.save(ticket4);
			trepository.save(ticket5);
